...
num of seeds =  1500
    ...
    folder_path = '/home/shellyf/Projects/data/procgen/'  # Update with your actual folder path
    ...
    for filename in os.listdir(folder_path):
        if filename.endswith('.npy'):
            ...
            if len(parts) >= 5:
                ...
                if level_seed in seed_games.keys() and seed_games[level_seed] < 15:
...
def add_index():
    ...
    for index, filename in enumerate(files, start=544):
